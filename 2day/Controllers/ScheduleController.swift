...
//  2day
//
//  Created by Anastasiya Dumyak on 3/27/17.
...
extension ScheduleController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
...
extension ScheduleController: CVCalendarViewAppearanceDelegate {
...
extension ScheduleController {
    @IBAction func switchChanged(sender: UISwitch) {
        calendarView.changeDaysOutShowingState(sender.isOn)
